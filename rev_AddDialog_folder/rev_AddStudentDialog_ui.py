...
class Ui_Add_Student_Dialog(object):
    def setupUi(self, AddStudent_Dialog):
        ...
        validator = QtGui.QRegularExpressionValidator(regex, self.id_number_input)
    ...
    def retranslateUi(self, AddStudent_Dialog):
        ...
        AddStudent_Dialog.setWindowTitle(_translate("AddStudent_Dialog", "Dialog"))
        ...
        self.gender_comboBox.setItemText(0, _translate("AddStudent_Dialog", "Male"))
        self.gender_comboBox.setItemText(1, _translate("AddStudent_Dialog", "Female"))
